...
- React: >= 17.0.2
- @mysteriumnetwork/node: >= 1.4.7 _// Client Mysterium Node_
- mysterium-vpn-js: > 15.1.0 _// Tequila API client_
- electron-builder: > 22.11.7

## Client application workflow

![Client-Supervisor-Node-WireGuard](docs/scheme.png)
...
As you can see building a dVPN application for Mysterium Network is simple enough. Just a few files for Node and Supervisor integration, Tequila API to control the Node and that's all.
